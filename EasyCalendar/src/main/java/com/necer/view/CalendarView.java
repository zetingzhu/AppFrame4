...
public class CalendarView extends View implements ICalendarView {
    ...
    public CalendarView(Context context, BaseCalendar calendar, LocalDate initialDate, CalendarType calendarType,int mPadding) {
        super(context);
        mCalendarHelper = new CalendarHelper(calendar, initialDate, calendarType ,   mPadding);
