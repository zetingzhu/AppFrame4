...
public class AttrsUtil {
    ...
    public static Attrs getAttrs(Context context, AttributeSet attributeSet) {
        ...
        attrs.todayCheckedSolarTextColor = ta.getColor(R.styleable.NCalendar_todayCheckedSolarTextColor, ContextCompat.getColor(context, R.color.N_defaultSolarTextColor));
        ...
        attrs.defaultUnCheckedSolarTextColor = ta.getColor(R.styleable.NCalendar_defaultUnCheckedSolarTextColor, ContextCompat.getColor(context, R.color.N_defaultUnCheckedSolarTextColor));
        ...
        attrs.calendarPaddingLeftRight = (int) ta.getDimension(R.styleable.NCalendar_calendarPaddingLeftRight, 0f);
