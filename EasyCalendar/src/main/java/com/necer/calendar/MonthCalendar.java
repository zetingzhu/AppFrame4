...
public class MonthCalendar extends BaseCalendar {
    ...
    @Override
    protected BasePagerAdapter getPagerAdapter(Context context, BaseCalendar baseCalendar, int mPadding) {
        return new MonthPagerAdapter(context,baseCalendar,mPadding);
    }
