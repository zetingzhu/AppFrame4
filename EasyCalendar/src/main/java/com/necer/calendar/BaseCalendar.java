...
public abstract class BaseCalendar extends ViewPager implements ICalendar {
    ...
    //历距离两个留空
    protected int calendarPaddingLeftRight;
    ...
    public BaseCalendar(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        mStartDate = LocalDate.parse(mDefaultStartDate);// new LocalDate(mDefaultStartDate);
        mEndDate = LocalDate.parse(mDefaultEndDateDate);// new LocalDate(mDefaultEndDateDate);
        ...
        calendarPaddingLeftRight = mAttrs.calendarPaddingLeftRight;
    ...
    private void initAdapter() {
        ...
        setPadding(calendarPaddingLeftRight, 0, calendarPaddingLeftRight, 0);
        BasePagerAdapter calendarAdapter = getPagerAdapter(mContext, this, calendarPaddingLeftRight);
    ...
    //回去viewpager的adapter
    protected abstract BasePagerAdapter getPagerAdapter(Context context, BaseCalendar baseCalendar, int mPadding);
