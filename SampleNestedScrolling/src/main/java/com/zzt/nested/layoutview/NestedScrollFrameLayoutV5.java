...
public abstract class NestedScrollFrameLayoutV5 extends FrameLayout
    ...
    public NestedScrollFrameLayoutV5(Context context) {
        super(context);
        this.initialize();
    }

    public NestedScrollFrameLayoutV5(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initialize();
    }

    public NestedScrollFrameLayoutV5(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.initialize();
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public NestedScrollFrameLayoutV5(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
