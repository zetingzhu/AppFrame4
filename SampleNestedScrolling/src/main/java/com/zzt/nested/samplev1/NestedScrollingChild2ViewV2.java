 ...
 * @date: 2021/3/31
 */
public class NestedScrollingChild2ViewV2 extends LinearLayout implements NestedScrollingChild2 {
    private static final String TAG = NestedScrollingChild2ViewV2.class.getSimpleName();
    ...
    public NestedScrollingChild2ViewV2(Context context) {
        this(context, null);

    }

    public NestedScrollingChild2ViewV2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NestedScrollingChild2ViewV2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
