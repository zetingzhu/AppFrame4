 ...
 */
public class NestedScrollingParent2LayoutV1 extends LinearLayout implements NestedScrollingParent2 {
    ...
    public NestedScrollingParent2LayoutV1(Context context) {
        this(context, null);
    }

    public NestedScrollingParent2LayoutV1(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NestedScrollingParent2LayoutV1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
